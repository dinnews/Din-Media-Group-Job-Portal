...
namespace Din_Media_Group_Job_Portal.SODailymotionUpload
{
    ...
    {
        public string startUplaod(HttpPostedFileBase Video_File)
        {
            ...
            //Console.ReadLine();
            return uploadedResponse.private_id;
        }
        ...
        private static string GetAccessToken()
        {
            ...
            //    HttpUtility.UrlEncode("dinnews123"));***********************Changes by Saleem************************
        ...
        private static void Authorize(string accessToken)
        {
            ...
            var authorizeUrl = String.Format("https://api.dailymotion.com/oauth/authorize?response_type=code&client_id={0}&scope=read+write+manage_videos+delete&redirect_uri={1}",
                ...
                //  var authorizeUrl = String.Format("https://api.dailymotion.com/oauth/authorize?response_type=code&client_id={0}&scope=read+write+manage_videos+delete&redirect_uri={1}",
                //HttpUtility.UrlEncode("3b2a68e42a7e5bf2dda2"),
            //HttpUtility.UrlEncode("http://localhost/[dynamic_part]*"));***************************Changes By Saleem******************
